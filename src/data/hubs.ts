...
export const SURVIVAL_HUBS: SurvivalHub[] = [
  ...
  },
  {
    ...
    intro: 'Mind & Attention is cognitive readiness: focus, working memory, recall, judgment, and independent thinking in a world of constant micro-assists. This is not “digital wellness,” it is resilience against cognitive offloading and distraction-by-design.',
    whatsHappening:
      'Micro-assists like autocomplete, summaries, copilots/agents, search, and second-brain tools now sit in every workflow. Offloading shifts what we retain; speed and fluency crowd out reasoning; interruptions normalize shallow attention; judgment gets outsourced to systems optimized for speed. The impact is plain: recall fades, deep work shrinks, and independent decision-making erodes. Teams start to expect instant answers, and uninterrupted thinking can read as “antisocial.”',
    actionSteps: [
      'Run a daily 60–90 minute no-assist sprint (no AI suggestions, no search), then review what changed.',
      'Set explicit rules for offloading vs. thinking (e.g., draft with AI, decide without AI).',
      'Maintain one fully-human domain (writing, math, negotiation) as a practiced edge.',
      'Use timeboxed communication windows to limit notifications and interruptions.',
    ],
