...
<div class="callout">
	<strong>TL;DR:</strong> AI tools can speed you up but can also make you dependent. Pick by skill gap. Run the 14-day test.
</div>

<figure class="figure-narrow">
	<img
		src="/images/cognitive-dependency-spiral.png"
		alt="Cognitive Dependency Spiral"
		class="img-medium"
		width="1200" height="800"
		loading="lazy" decoding="async"
		sizes="(min-width:1024px) 768px, 100vw"
	/>
	<figcaption class="figcap">How “quick answers” drift into dependency.</figcaption>
</figure>
...
| Your goal | Use this | Why it fits | Watch out |
|---|---|---|---|
...
<figure class="figure-wide">
	<img
		src="/images/ease-vs-survival-plot.png"
		alt="Ease of Use vs Cognitive Survival"
		class="img-wide"
		width="1600" height="1000"
		loading="lazy" decoding="async"
		sizes="(min-width:1280px) 1024px, 100vw"
	/>
	<figcaption class="figcap">Comfort trades off with long-term survival. Choose deliberately.</figcaption>
</figure>
...
<figure class="figure-narrow">
	<img
		src="/images/cognitive-survival-stack.png"
		alt="Cognitive Survival Stack"
		class="img-medium"
		width="1200" height="800"
		loading="lazy" decoding="async"
		sizes="(min-width:1024px) 768px, 100vw"
