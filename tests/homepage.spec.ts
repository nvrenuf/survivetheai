...
test.describe('Homepage layout', () => {
  ...
  test('featured story stays distinct from latest intelligence cards', async ({ page }) => {
    ...
    await expect(page.getByTestId('latest-intelligence-section')).toContainText('Editorial context');
    await expect(page.getByTestId('latest-intelligence-section')).toContainText('New pressure points');
  });
});
